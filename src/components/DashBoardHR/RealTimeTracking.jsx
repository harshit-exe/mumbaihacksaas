...
import { Clock, ChevronDown, ChevronUp, CheckCircle2, XCircle, AlertCircle, Search, BarChart2, Users } from 'lucide-react'
      ...
      resolve([
        {
          ...
          tasks: [
            { id: 101, name: 'Implement user authentication', status: 'completed', dueDate: '2024-03-20' },
            { id: 102, name: 'Design dashboard layout', status: 'in-progress', dueDate: '2024-03-25' },
            { id: 103, name: 'Optimize database queries', status: 'pending', dueDate: '2024-03-30' },
          ]
        },
        {
          id: 2,
          ...
          tasks: [
            { id: 201, name: 'Review pull requests', status: 'completed', dueDate: '2024-03-18' },
            { id: 202, name: 'Update documentation', status: 'pending', dueDate: '2024-03-22' },
            { id: 203, name: 'Fix reported bugs', status: 'in-progress', dueDate: '2024-03-24' },
          ]
        },
        {
          id: 3,
          ...
          tasks: [
            { id: 301, name: 'Write unit tests', status: 'completed', dueDate: '2024-03-19' },
            { id: 302, name: 'Perform integration testing', status: 'in-progress', dueDate: '2024-03-23' },
            { id: 303, name: 'Document test results', status: 'pending', dueDate: '2024-03-26' },
          ]
        },
        {
          id: 4,
          ...
          tasks: [
            { id: 401, name: 'Redesign login page', status: 'completed', dueDate: '2024-03-17' },
            { id: 402, name: 'Create new icons', status: 'in-progress', dueDate: '2024-03-21' },
            { id: 403, name: 'Conduct user testing', status: 'pending', dueDate: '2024-03-28' },
          ]
        },
      ])
...
export default function RealTimeTracking() {
        ...
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <div className="flex items-center space-x-2">
            ...
            <div>
              ...
              <CardDescription className="text-sm">{employee.currentTask}</CardDescription>
            </div>
          </div>
          <TooltipProvider>
            <Tooltip>
        ...
        <CardContent>
          <div className="flex justify-between items-center mb-2">
            <div className="flex items-center space-x-1">
              ...
              <span className="text-sm text-gray-500">Last active: {formatLastActivity(employee.lastActivity)}</span>
            </div>
          </div>
          ...
          >
            <CollapsibleTrigger asChild>
              <Button variant="ghost" className="w-full flex justify-between items-center p-2">
                ...
                {expandedEmployee === employee.id ? <ChevronUp className="h-4 w-4" /> : <ChevronDown className="h-4 w-4" />}
              </Button>
            </CollapsibleTrigger>
  ...
  return (
    <div className="container mx-auto p-4  min-h-screen">
      ...
      >
        <h1 className="text-4xl font-bold mb-2 text-blue-800">Employee Tracking Dashboard</h1>
        <p className="text-gray-600">Real-time monitoring of employee activities and tasks</p>
      </motion.div>
      ...
      <div className="mb-6 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0 md:space-x-4">
        ...
        <div className="flex space-x-2">
          <Button variant={currentView === 'grid' ? 'secondary' : 'outline'} onClick={() => setCurrentView('grid')}>
              ...
              <TableBody>
                {filteredAndSortedEmployees.map((employee) => (
                  <TableRow key={employee.id}>
                    ...
                    <TableCell>
                      <Progress value={employee.productivity} className="h-2 w-[100px]" />
                    </TableCell>
