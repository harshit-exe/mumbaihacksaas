...
const initialTasks = [
  ...
  { id: 2, name: 'Bug fixing', priority: 'medium', skillMatch: 92, deadline: '2024-03-10', status: 'pending', description: 'Fix reported issues in the dashboard', employeeId: 'EMP002' },
  { id: 3, name: 'Documentation update', priority: 'low', skillMatch: 78, deadline: '2024-03-20', status: 'completed', description: 'Update user manual with new features', employeeId: 'EMP003' },
]
  ...
  return (
    <div className="container mx-auto p-4 min-h-screen">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 space-y-4 md:space-y-0 md:space-x-4">
        ...
        >
          <Button onClick={() => setIsFormOpen(true)} className="w-full md:w-auto bg-blue-600 hover:bg-blue-700 text-white">
        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead className="cursor-pointer" onClick={() => requestSort('skillMatch')}>
                Skill Match
              ...
              <TableRow key={task.id}>
                ...
                <TableCell>
                  <div className="flex space-x-2">
                    ...
                    <Button variant="ghost" className="text-red-600 hover:text-red-800" onClick={() => deleteTask(task.id)}>
